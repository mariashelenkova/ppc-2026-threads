...
void ShelenkovaMShellSortSimpleMergeALL::BaseShellSort(std::vector<int>::iterator first,
...
std::vector<std::size_t> ShelenkovaMShellSortSimpleMergeALL::GetBounds(std::size_t n, std::size_t parts) {
...
void ShelenkovaMShellSortSimpleMergeALL::ShellSortMerge(std::vector<int> &vec) {
  if (vec.empty()) {
    return;
  }
